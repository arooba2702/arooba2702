...
I'm currently building out a portfolio of end-to-end data analysis projects, and completing a Python Programming internship to strengthen my automation and scripting skills.
...
Databases SQL (Schema Design, Joins, Aggregations, Reporting), MySQL

Data Analysis & Visualization Python (Pandas, NumPy), Power BI, IBM Cognos, Excel, Matplotlib, Seaborn
...
Antimicrobial Resistance (AMR) Surveillance Analytics — Python/Pandas analysis of microbiology lab data with an interactive Power BI dashboard (in progress)
Fraud Detection & Analysis System — EDA and statistical analysis of financial transaction data with a Power BI monitoring dashboard (in progress)
Current Focus
Finishing and documenting my first two flagship data analysis projects (see above)
Completing a Python Programming internship (Syntecxhub)
Strengthening SQL through structured practice projects
